...
zstyle :compinstall filename '/home/yaroot/.zshrc'
...
alias ll='ls -G -ahl'
alias la='ls -g -hl'
#alias lll='ls -G -hal | less'
#alias llg='ls -G -hal | grep --color=auto -n'
alias more='less'
...
#alias rdd='rdesktop -u administrator -g 1600x1000 -r sound:local -r clipboard -5 -x 0x80 -z -b -M'
alias rdd='rdesktop -u administrator -g 1600x1000 -r clipboard -5 -x 0x80 -z -b -M'
...
alias g='git'
alias gs='git status'
alias fuckgfw='ssh -CD 7070 root@a.yeerx.com'
alias v='gvim'
alias vd='vimdiff'
alias gd='gvimdiff'
